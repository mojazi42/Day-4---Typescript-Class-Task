...
var user1 = { id: 1, name: "Mohammed", email: "Mohammed@example.com", isAdmin: true };
var user2 = { id: 2, name: "Abdulaziz", email: "Abdulaziz@gmail.com" };
...
var product1 = new Product("Laptop", 1000, "Electronics");
...
console.log(filterArray(numbers, function (num) { return num % 2 === 0; })); // [2, 4, 6]
